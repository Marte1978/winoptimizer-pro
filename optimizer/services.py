...
SAFE_SERVICES_TO_DISABLE: list[dict] = [
    ...
    },
    {
        ...
        "description": "Servicio de impresión. Deshabilitar si no usas impresoras. Vector histórico de vulnerabilidades.",
        "risk": "low",
        "category": "hardware",
        "win10": True,
        "win11": True,
    ...
    },
    {
        "name": "Fax",
        "display": "Fax Service",
        "description": "Servicio de fax. Prácticamente nadie lo usa en equipos modernos.",
        "risk": "low",
        "category": "hardware",
        "win10": True,
        "win11": True,
